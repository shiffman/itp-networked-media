...
function preload() {
  largeImage = loadImage('data/large.jpg'); // preloading the image guarantees it will be ready by setup()
}

function setup() {
  createCanvas(1300, 600);
  //largeImage = loadImage('data/large.jpg');   // loading the image here is too slow
  noLoop();
}
